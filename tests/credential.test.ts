...
describe('pickToken', () => {
  const inference =
    '9d1c250a:00000000-0000-4000-8000-000000000000:https://api.anthropic.com:user:inference user:profile';
  const profileOnly =
    'a473d7bb:00000000-0000-4000-8000-000000000000:https://api.anthropic.com:user:profile';
